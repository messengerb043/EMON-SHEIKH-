module.exports.config = {
 ...
 version: "1.0.0",
 hasPermssion: 0,
 credits: "—͟͟͞͞[ʜᴀꜱɪʙᴜʟ ɪꜱʟᴀᴍ ᴇᴍᴏɴ]", //don't change my credit 
...
module.exports.run = async ({ api, event, args }) => {
 ...
 return api.sendMessage(`✅ —͟͟͞͞[ʜᴀꜱɪʙᴜʟ ɪꜱʟᴀᴍ ᴇᴍᴏɴ] কল বোম্বিং সম্পন্ন হয়েছে ${number} নম্বরে।`, event.threadID, event.messageID);
 } catch (error) {
